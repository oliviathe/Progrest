...
return [
    ...
    | ukuran. Silakan sesuaikan setiap pesan ini sesuai kebutuhan.
    |
    */
    ...
    'digits_between' => 'Kolom :attribute harus terdiri antara :min dan :max angka.',
    ...
    |--------------------------------------------------------------------------
    |
    | Di sini kamu dapat menentukan pesan validasi kustom untuk atribut dengan
    | konvensi "attribute.rule" untuk menamai barisnya. Ini mempercepat
    | penentuan baris bahasa kustom tertentu untuk aturan atribut tertentu.
    |
    */
